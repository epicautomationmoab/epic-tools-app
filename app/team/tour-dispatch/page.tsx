...
export default async function TourDispatchPage() {
  ...
  const params = new URLSearchParams({
    select: "store_visit_id,readiness_id,confirmation_code,customer_name,product_display_name,visit_start_time,total_vehicle_count,vehicle_slot,vehicle_label,checkout_mileage,checkout_engine_hours,checkout_status",
    ...
    <div className={shellStyles.page}>
      ...
      <main className={shellStyles.main}>
        ...
        <section className={styles.content}>
          <div className={styles.intro}>Today’s guest-driven MPWR tour vehicles. Enter the car number, departure mileage, and engine hours for each vehicle.</div>
