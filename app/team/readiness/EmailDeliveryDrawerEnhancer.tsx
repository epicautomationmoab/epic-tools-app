...
export default function EmailDeliveryDrawerEnhancer() {
  useEffect(() => {
    ...
    function enhance() {
      ...
      const existingCaution = emailLabel.querySelector('[data-email-delivery-caution="true"]');
      const existingDismiss = emailLabel.querySelector('[data-email-delivery-dismiss="true"]');
      ...
      if (!existingDismiss) {
        ...
        dismissButton.onclick = async (event) => {
