...
export default function AmbassadorAdminRewardsPage(){
  ...
  return <main style={{minHeight:"100vh",background:"#f1f3f5",color:"#202733",fontFamily:"Arial,sans-serif"}}>
    <header style={{background:"#202733",color:"white",padding:"16px 26px",display:"flex",alignItems:"center",justifyContent:"space-between",gap:20}}>
      ...
      <nav style={{display:"flex",gap:8}}><button onClick={()=>window.location.href="/ambassador/admin"} style={{border:"1px solid rgba(255,255,255,.28)",background:"transparent",color:"white",borderRadius:8,padding:"9px 13px",fontWeight:800,cursor:"pointer"}}>Ambassadors</button><button style={{border:0,background:"#d5521d",color:"white",borderRadius:8,padding:"9px 13px",fontWeight:900}}>Rewards Catalog</button></nav>
    </header>

    <div style={{padding:26}}>
      <section style={{background:"white",border:"1px solid #dfe4ea",borderRadius:14,padding:22}}>
        <div style={{display:"flex",justifyContent:"space-between",gap:20,alignItems:"flex-start",marginBottom:18}}><div><h1 style={{margin:0,fontSize:28}}>Rewards Catalog</h1><p style={{margin:"6px 0 0",color:"#68717d",fontSize:13}}>Add, edit, deactivate, reorder, and price the rewards Ambassadors can choose on the Redeem page. Changes appear automatically in the Ambassador portal.</p></div></div>
